<?php
    ...
    function vmostrarIToplistas($consulta)
    {
        $aux = leerfichero("fonts/Itoplistas.html");
	...
	function vmostrarITopcanciones($consulta)
    {
		$aux = leerfichero("fonts/Itopcanciones.html");
        $partes = explode("##FILALISTA##", $aux);
		$contenido = "";
		$lista = "";
		$i = 1;
